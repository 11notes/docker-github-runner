...
RUNNER_TOKEN=$(curl -X POST -H "Authorization: token ${RUNNER_ADMINISTRATION_TOKEN}" -H "Accept: application/vnd.github+json" https://api.github.com/repos/${RUNNER_REPO}/actions/runners/registration-token | jq .token --raw-output)
